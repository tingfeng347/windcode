...
def test_model_stream_idle_timeout_defaults_and_validation() -> None:
    assert AppConfig().budgets.model_stream_idle_timeout_seconds == 60
    with pytest.raises(ValidationError):
        AppConfig.model_validate({"budgets": {"model_stream_idle_timeout_seconds": 0}})
