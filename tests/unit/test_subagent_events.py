...
def test_all_subagent_events_round_trip() -> None:
    ...
    events = (
        ...
        SubagentMessageSent(
            **fields,
            message_id="message",
            sender_subagent_id="child",
            sender_task_name="fix_tests",
            recipient_subagent_id="peer",
            recipient_task_name="review",
            content="please review",
        ),
        SubagentMessageDelivered(
            **fields,
            message_id="message",
            sender_subagent_id="peer",
            sender_task_name="review",
            recipient_subagent_id="child",
            recipient_task_name="fix_tests",
            content="looks good",
        ),
